        ...
        <div class="col-md-4 ml-auto mr-auto no-border rounded shadow-lg" style="backdrop-filter: blur(10px);"> 
            ...
            <div class="card card-login card-plain"> 
                ...
                <div class="input-group no-border form-control-lg {{ $errors->has('email') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Username ou Email') }}" type="text" name="email" value="{{ old('email', 'admin@nowui.com') }}" required autofocus>
                </div>
                @if ($errors->has('email'))
                ...
                <div class="input-group no-border form-control-lg {{ $errors->has('password') ? ' has-danger' : '' }}" >
                    ...
                    <input placeholder="Password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="{{ __('Palavra-passe') }}" type="password" value="secret" required>
                </div>
